...
The SourceID prefix consists of '*branner:*' followed by an abbreviation of the collection name followed by an underscore. The filename for the layer is appended to the prefix to create the SourceID. (ex. *branner:fmmp12_alameda2012.shp*)
